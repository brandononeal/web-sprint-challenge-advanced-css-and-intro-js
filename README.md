...
1. How would you describe acessibility on the web to someone new to programming?
    Accessability is creating your website so that anyone regardless of disabilities can access it
2. Talk about 3 different things you can do to ensure your website is accessible. 
    Use semantic HTML, use scalable units, and use alt text on your images
3. How would you explain the concept of a variable to someone new to programming?
    A variable is a container to store information
4. What is the purpose of using functions in code?
    A function is used when you need to reuse your code ith diffent variables (arguements)
